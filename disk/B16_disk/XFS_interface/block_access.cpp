...
// to get the block type of a block
...
// to get a free block of a given type
...
// to get a free record block 
// getFreeBlock(block_type) is the latest used function in the software
...
// to get a free slot in a given block number
...
// to get a record from a particular slot of a block
...
// to set a particular slot of a block with given record
...
int ba_delete(char relName[ATTR_SIZE])
{
	...
	prev_recid.block=-1;
	prev_recid.slot=-1;
	unsigned char slotmap[20];int root_block;
	union Attribute a[6];
	//getRecord(a,5,16);
	/*cout<<"dddddd\n";
	cout<<a[0].sval<<endl;*/
