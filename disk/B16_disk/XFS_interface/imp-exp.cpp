...
// to return data type of given argument
...
//To insert a single record into a relation
...
// To insert records from a file into a relation
...
// Function to import a relation from Unix system to the disk
...
//Function to export a relation to a given filename
...
//To list all relations in the disk
void ls()
{
	union Attribute attr[6];
	int attr_blk=4;
